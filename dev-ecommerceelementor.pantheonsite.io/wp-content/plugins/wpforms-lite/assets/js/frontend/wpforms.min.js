var wpforms =
  ...
  (function (s, p, d) {
    const l = {
      ...
      init() {
        d(l.ready),
          d(p).on("load", function () {
            "function" == typeof d.ready.then ? d.ready.then(l.load) : l.load();
          }),
          l.bindUIActions(),
          l.bindOptinMonster();
      },
      ready() {
        l.clearUrlQuery(),
          ...
          l.loadChoicesJS(),
          l.initTokenUpdater(),
          l.restoreSubmitButtonOnEventPersisted(),
          l.bindSmartPhoneField(),
          l.bindChoicesJS(),
      ...
      loadHoneypot() {
        d(".wpforms-form").each(function () {
          const e = d(this),
            ...
            a = [];
          var o, i, s, n;
          void 0 !== wpforms_settings.hn_data[t] &&
            (d(`#wpforms-form-${t} .wpforms-field`).each(function () {
              var e = d(this);
              r.push(e.data("field-id")),
                a.push(e.find(".wpforms-field-label").text());
            }),
            (o = l.getHoneypotRandomLabel(a.join(" ").split(" "))),
            (i = l.getHoneypotFieldId(r)),
            (n = r[Math.floor(Math.random() * r.length)]),
            (s = `wpforms-${t}-field_` + i),
            d(`#wpforms-${t}-field_${n}-container`, e).before(`
            ...
            (n = d(
              `#wpforms-${t}-field_${wpforms_settings.hn_data[t]}-container`,
              e
            ))
              .find("input")
              .attr({ tabindex: "-1", "aria-hidden": "true" }),
            n.find("label").attr("aria-hidden", "true"));
        });
      },
        ...
        void 0 !== d.fn.validate &&
          ...
          d.validator.addMethod(
            ...
            function (e, t) {
              ...
              return (
                ...
                Object.prototype.hasOwnProperty.call(l.cache, r) &&
                Object.prototype.hasOwnProperty.call(
                  l.cache[r],
                  "restrictedEmailValidation"
                ) &&
                Object.prototype.hasOwnProperty.call(
                  l.cache[r].restrictedEmailValidation,
                  e
                )
                  ? l.cache[r].restrictedEmailValidation[e]
                  : (l.restrictedEmailRequest(t, e), "pending"))
              );
            },
          ...
          d.validator.addMethod(
            ...
            function (e, t) {
              ...
              return (
                void 0 === r ||
                !(t.prop("required") || !l.empty(e)) ||
                ((t = t.data("max-time")),
                l.compareTimesGreaterThan(t, r)
                  ? l.compareTimesGreaterThan(e, r) &&
                    l.compareTimesGreaterThan(t, e)
                  : (l.compareTimesGreaterThan(e, r) &&
                      l.compareTimesGreaterThan(e, t)) ||
          ...
          void 0 !== p.intlTelInput &&
            d.validator.addMethod(
              ...
              function (e, t) {
                ...
                return (
                  !e.match(/[^\d()\-+\s]/) &&
                  ((e = p.intlTelInputGlobals?.getInstance(t)),
                  (r = d(t).triggerHandler("validate")),
                  this.optional(t) || e?.isValidNumberPrecise() || r)
                );
              },
          ...
          d.validator.addMethod(
            ...
            function (e, t, r) {
              ...
              return (
                ...
                Number(l.amountSanitize(l.amountFormat(r))) <=
                  Number(l.amountSanitize(e))
              );
            },
          ...
          d.validator.addMethod(
            ...
            function (e, t) {
              ...
              return (
                ("" === e && !r.hasClass("wpforms-field-required")) ||
                t >= Number(r.data("password-strength-level"))
              );
            },
          ...
          d(".wpforms-validate").each(function () {
            ...
            (r =
              void 0 !== p["wpforms_" + t] &&
              p["wpforms_" + t].hasOwnProperty("validate")
                ? p["wpforms_" + t].validate
                ...
                : {
                    ...
                    invalidHandler(e, t) {
                      void 0 !== t.errorList[0] &&
                        l.scrollToError(d(t.errorList[0].element));
                    },
          ...
          d.post({
            ...
            success(e) {
              ...
              e ||
                ...
                o.showErrors(t)),
                (l.cache[i].restrictedEmailValidation =
                  l.cache[i].restrictedEmailValidation || []),
                Object.prototype.hasOwnProperty.call(
                  l.cache[i].restrictedEmailValidation,
                  a
                ) || (l.cache[i].restrictedEmailValidation[a] = e),
                o.stopRequest(r, e);
            },
          });
      },
        ...
        void 0 !== d.fn.flatpickr &&
          (e = e?.length ? e : d(s))
            ...
            .each(function () {
              ...
              var s;
              !(i =
                void 0 !== p["wpforms_" + r + "_" + o] &&
                p["wpforms_" + r + "_" + o].hasOwnProperty("datepicker")
                  ? p["wpforms_" + r + "_" + o].datepicker
                  : void 0 !== p["wpforms_" + r] &&
                    p["wpforms_" + r].hasOwnProperty("datepicker")
                  ? p["wpforms_" + r].datepicker
        ...
        void 0 !== d.fn.timepicker &&
          (e = e?.length ? e : d(s))
            ...
            .each(function () {
              ...
              let a;
              a =
                void 0 !== p["wpforms_" + t + "_" + r] &&
                p["wpforms_" + t + "_" + r].hasOwnProperty("timepicker")
                  ? p["wpforms_" + t + "_" + r].timepicker
                  : void 0 !== p["wpforms_" + t] &&
                    p["wpforms_" + t].hasOwnProperty("timepicker")
                  ? p["wpforms_" + t].timepicker
      ...
      fixPhoneFieldSnippets(t) {
        t.siblings('input[type="hidden"]').each(function () {
          ...
          d(this).attr("name").includes("function") &&
            ...
            (p.intlTelInputGlobals.getInstance(t[0]).destroy(),
        ...
        if (void 0 !== p.intlTelInput) {
          ...
          if (
            ...
            wpforms_settings.gdpr &&
              ((r = l.mapLanguageToIso(this.getFirstBrowserLanguage())),
              (t = -1 < r.indexOf("-") ? r.split("-").pop() : r)),
            t)
          ) {
            let e = p.intlTelInputGlobals.getCountryData();
            ...
            (e = e?.length ? e : d(s))
              ...
              .each(function (e, t) {
                ...
                if (r.parents(".elementor-location-popup").is(":hidden"))
                  return !1;
                if ("object" != typeof r.data("plugin_intlTelInput")) {
                  (a.hiddenInput = function (e) {
                    return { phone: e };
                  }),
                    (a.utilsScript =
                      wpforms_settings.wpforms_plugin_url +
                      "assets/pro/lib/intl-tel-input/module.intl-tel-input-utils.min.js");
                  let e = p.intlTelInput(r.get(0), a);
                  r.on("validate", function () {
                    return e.isValidNumber(e.getNumber());
                  }),
                    r.data("plugin_intlTelInput", e),
                    d.fn.extend({
                      intlTelInput(e) {
                        var t = d(this);
                        if ("destroy" !== e) return p.intlTelInput(t.get(0), e);
                        p.intlTelInputGlobals.getInstance(t[0]).destroy();
                      },
                    }),
                    ...
                    r.on("blur input", function () {
                      (e = p.intlTelInputGlobals.getInstance(r[0])),
                        r.siblings('input[type="hidden"]').val(e.getNumber());
                    });
                }
              });
        }
          ...
          (i = i?.length ? i : d(s))
            ...
            .each(function (e, t) {
              ...
              d(t).data("choicesjs") ||
                WPFormsUtils.triggerEvent(
                  i,
                  "wpformsBeforeLoadElementChoices",
                  [t]
                ).isDefaultPrevented() ||
                ((r = p.wpforms_choicesjs_config || {}),
      ...
      bindUIActions() {
        ...
        e.on("click", ".wpforms-page-button", function (e) {
          ...
          e.on("change input", "select.wpforms-payment-quantity", function () {
            l.amountTotal(this, !0), l.updateOrderSummaryItemQuantity(d(this));
          }),
          ...
          e
            ...
            .one("focus", ".dropzone-input", l.formChanged)
            .one("click touchstart", ".wpforms-signature-canvas", l.formChanged)
            .one("wpformsRichTextContentChange", l.richTextContentChanged),
      ...
      skipEmptyPages(e, t, r, a) {
        var o = l.findNonEmptyPage(t, r, a);
        o !== t &&
          (e.preventDefault(),
          1 === o && "prev" === a
      ...
      findNonEmptyPage(e, t, r) {
        let a = e;
        for (; l.isEmptyPage(t, a); ) "prev" === r ? a-- : a++;
        return a;
      },
      isEmptyPage(e, t) {
        return (
      ...
      formChanged(e) {
        ...
        l.maybeSetStartTime(t);
      },
      richTextContentChanged(e, t, r) {
        (r = r.getContainer()), (r = d(r).closest(".wpforms-form"));
        l.maybeSetStartTime(r);
      },
      initFormsStartTime() {
        d(".wpforms-form").each(function () {
          l.maybeSetStartTime(d(this));
        });
      },
      maybeSetStartTime(e) {
        e.data("start_timestamp") || e.data("start_timestamp", Date.now());
      },
        ...
        if (!t.hasClass("wpforms-disabled")) {
          ...
          "next" === r ? (e += 1) : "prev" === r && --e,
            WPFormsUtils.triggerEvent(t, "wpformsBeforePageChange", [
              ...
              l.toggleReCaptchaAndSubmitDisplay(o, r, a),
              l.checkTurnstileVisibility(o),
              (a = l.getPageScroll(o)) &&
                l.animateScrollTop(o.offset().top - a, 750, null),
              t.trigger("wpformsPageChange", [e, o, r]),
              l.manipulateIndicator(e, o));
        }
      },
      ...
      checkTurnstileVisibility(e) {
        var t,
          e = e.find(".wpforms-recaptcha-container");
        e.hasClass("wpforms-is-turnstile") &&
          ((t = e.find(".g-recaptcha").height()),
          0 === parseInt(t, 10)
            ? e.addClass("wpforms-is-turnstile-invisible")
            : e.removeClass("wpforms-is-turnstile-invisible"));
      },
      getPageScroll(e) {
        return (
          !1 !== p.wpforms_pageScroll &&
          (l.empty(p.wpform_pageScroll)
      ...
      bindOptinMonster() {
        s.addEventListener("om.Campaign.load", function (e) {
          ...
          s.addEventListener("om.Campaign.afterShow", function (e) {
            "undefined" != typeof WPFormsRepeaterField &&
              WPFormsRepeaterField.ready();
          }),
          d(s).on("OptinMonsterOnShow", function (e, t, r) {
            l.ready(),
              l.optinMonsterRecaptchaReset(t.optin),
              "undefined" != typeof WPFormsRepeaterField &&
                WPFormsRepeaterField.ready();
          });
      },
      ...
      amountTotal(e, t) {
        ...
        const r = d(e).closest(".wpforms-form"),
          a = l.amountTotalCalc(r),
          o = l.amountFormatSymbol(a);
        r.find(".wpforms-payment-total").each(function () {
          ...
          l.updateOrderSummaryItems(r, d(e), o);
      },
      updateOrderSummaryItems(t, e, r) {
        t.find(".wpforms-order-summary-preview").each(function () {
          ...
          "" !== r &&
            ...
            t.find(".wpforms-payment-price").each(function () {
              l.updateOrderSummaryItem(d(this), e);
            });
        });
      },
      updateOrderSummaryItem(e, t) {
        if (e.hasClass("wpforms-payment-price")) {
          const o = e.closest(".wpforms-field"),
            i = o.data("field-id"),
            s = e.prop("type"),
            n = "block" === o.css("display");
          var r, a;
          "checkbox" === s || "radio" === s || "select-one" === s
            ? t.find(`tr[data-field="${i}"]`).each(function () {
                var e = d(this).data("choice"),
                  e =
                    "select-one" === s
                      ? e === parseInt(o.find("select").val(), 10)
                      : o.find(`input[value="${e}"]`).is(":checked");
                d(this).toggle(n && e);
              })
            : ((r = t.find(`tr[data-field="${i}"]`)),
              ...
              r
                ...
                .text(l.amountFormatSymbol(l.amountSanitize(a))),
              r.toggle(n)),
            o.hasClass("wpforms-payment-quantities-enabled")
              ? l.updateOrderSummaryItemQuantity(e)
              : (l.updateSummaryPriceWidth(t), l.toggleSummaryPlaceholder(t));
        }
      },
      updateOrderSummaryItemQuantity(e) {
        const t = e.closest(".wpforms-field"),
          ...
          o = t.data("field-id"),
          i = l.getPaymentFieldQuantity(a),
          s = l.getPaymentFieldAmount(a),
          n = a.prop("type");
        r.find(".wpforms-order-summary-preview").each(function () {
          ...
          (r =
            ...
            r
              .find(".wpforms-order-summary-item-price")
              .text(l.amountFormatSymbol(s * i)),
            l.updateSummaryPriceWidth(t),
            l.toggleSummaryPlaceholder(t);
        });
      },
      ...
      amountTotalCalc(e) {
        ...
        d(".wpforms-payment-price", e).each(function () {
          ...
          t
            ...
            ((e = l.getPaymentFieldAmount(t)) &&
              (r = Number(r) + e * l.getPaymentFieldQuantity(t)));
        });
        var t = d(s),
      ...
      getPaymentFieldAmount(e) {
        ...
        return "text" === t || "hidden" === t
          ? Number(l.amountSanitize(e.val()))
          : ("radio" !== t && "checkbox" !== t) || !e.is(":checked")
          ? e.is("select") &&
            0 < e.find("option:selected").length &&
            e.find("option:selected").data("amount")
            ? Number(l.amountSanitize(e.find("option:selected").data("amount")))
            : 0
          : Number(l.amountSanitize(e.data("amount")));
      },
      ...
      setUserIdentifier() {
        if (
          ((!p.hasRequiredConsent &&
            "undefined" != typeof wpforms_settings &&
            wpforms_settings.uuid_cookie) ||
            (p.hasRequiredConsent && p.hasRequiredConsent())) &&
      ...
      currentIpToCountry(r) {
        if (wpforms_settings.country) r(wpforms_settings.country);
        else {
          const t = function () {
      ...
      displayFormAjaxGeneralErrors(e, t) {
        ...
        e &&
          ...
          (l.empty(t) ||
            ...
            "string" == typeof t
              ? ((a = l.isModernMarkupEnabled() ? ' role="alert"' : ""),
                ...
                l.setCurrentPage(e, {}))
              : ((a = e.data("formid")), l.printGeneralErrors(e, t, a))));
      },
      ...
      displayFormAjaxFieldErrors(r, e) {
        ...
        r &&
          ...
          (l.empty(e) ||
            ((t = r.data("validator")) &&
              ((e = l.splitFieldErrors(e)),
              d.each(e, function (e, t) {
                d('[name="' + e + '"]', r).attr("data-server-error", t);
              }),
              t.showErrors(e),
              l.formHasCaptcha(r) || t.focusInvalid())));
      },
      splitFieldErrors: (i) => (
      ...
      formSubmitAjax: (a) => {
        ...
        let t;
        r.css("opacity", 0.6), e.show(), l.clearFormAjaxGeneralErrors(a);
        var o = new FormData(a.get(0)),
          o =
            (o.append("action", "wpforms_submit"),
            o.append("start_timestamp", a.data("start_timestamp")),
        ...
        return (
                  ...
                  e.data &&
                    (e.data.redirect_url
                      ? (a.trigger("wpformsAjaxSubmitBeforeRedirect", e),
                        (p.location = e.data.redirect_url))
                      : e.data.confirmation &&
          ...
          WPFormsUtils.triggerEvent(a, "wpformsAjaxBeforeSubmit", [
            ...
            ? (l.restoreSubmitButton(a, r), d.Deferred().reject())
            : d.ajax(o)
        );
      },
      setCurrentPage(r, a) {
        if (0 !== r.find(".wpforms-page-indicator").length) {
          ...
          if (
            ...
            l.navigateToPage(a, t, o, r, d(".wpforms-page-" + o));
          }
        }
      },
