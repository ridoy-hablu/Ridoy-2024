jQuery(function (o) {
  ...
  "hidden" === Cookies.get(e)
    ...
    o(".woocommerce-store-notice__dismiss-link").on("click", function (t) {
    ...
    o(".woocommerce-input-wrapper :input")
      .on("keydown", function (e) {
        ...
        if (27 === e.which && t.length && t.is(":visible"))
          return t.prop("aria-hidden", !0).slideUp(250), e.preventDefault(), !1;
      })
    ...
    o("a.coming-soon-footer-banner-dismiss").on("click", function (e) {
      ...
      o.ajax({
        ...
        beforeSend: function (o) {
          o.setRequestHeader("X-WP-Nonce", t.data("rest-nonce"));
        },
        complete: function () {
