    ...
    (o.fn.zoom = function (e) {
      return this.each(function () {
        ...
        if (!n.url) {
          ...
          if (
            (s &&
              ((n.url = s.getAttribute("data-src") || s.currentSrc || s.src),
              ...
              t.init(),
                ...
                r
                  ...
                  .fadeTo(
                    ...
                    1,
                    "function" == typeof n.onZoomIn && n.onZoomIn.call(c)
                  );
            }
            function s() {
              r.stop().fadeTo(
                n.duration,
                0,
                "function" == typeof n.onZoomOut && n.onZoomOut.call(c)
              );
            }
            "grab" === n.on
              ...
              n.touch &&
                a
                  ...
                  .on("touchend.zoom", function (o) {
                    o.preventDefault(), f && ((f = !1), s());
                  }),
              "function" == typeof n.callback && n.callback.call(c);
          }),
